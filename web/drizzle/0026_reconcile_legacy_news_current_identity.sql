-- Reconcile the rollback-only legacy News projection after the final CURRENT
-- generation is activated. Preserve obsolete derived rows as explicit
-- SUPERSEDED_CONTRACT evidence instead of deleting them.
