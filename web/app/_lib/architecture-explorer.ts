...
export type ArchitectureState = "UNKNOWN" | "CURRENT" | "PENDING" | "TARGET" | "PAUSED" | "RETAINED";
export type ArchitecturePathState = "SOURCE_ONLY" | "CURRENT_PATH" | "PENDING_PATH" | "LEGACY_SHIM" | "TARGET_PATH";
...
export type ArchitectureCriticality = "UNKNOWN" | "CRITICAL" | "BACKGROUND" | "OPTIONAL" | "CONTROL_PLANE";
...
const CRITICALITIES = new Set<ArchitectureCriticality>(["UNKNOWN", "CRITICAL", "BACKGROUND", "OPTIONAL", "CONTROL_PLANE"]);
