export const LIVE_SCHEMA_VERSION = "PUBLIC_LIVE_V2";
...
const PRIVATE_KEYS = new Set([
  ...
  "forecast", "research_forecast", "recent_decisions",
]);
...
export function validateLiveState(value) {
  ...
  if (!object(value.health)) throw new TypeError("invalid summaries");
...
export function stateUpdate(next) {
  return { ...next };
}
