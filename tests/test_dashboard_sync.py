...
def test_sync_entrypoint_reexports_canonical_resource_contracts() -> None:
    from xauusd_forecaster.dashboard import resource_contracts

    module = _sync_module()

    assert module.remote_snapshot is resource_contracts.remote_snapshot
    assert module.learning_history_records is resource_contracts.learning_history_records
    assert module.market_chart_snapshot is resource_contracts.market_chart_snapshot
    assert module.PayloadContractError is resource_contracts.PayloadContractError
