...
def load(name, filename):
    spec = importlib.util.spec_from_file_location(name, ROOT / "scripts/runtime" / filename)
...
def main():
    ...
    if args.query_comparison_only:
        ...
        result = {"state": "NOT_RUN", "source_revision": git("rev-parse", "HEAD"),
            ...
            "api_sha256": digest_file(ROOT / "scripts/runtime/run_dashboard_api.py"),
    ...
    report = {
        ...
        "producer": "scripts/maintenance/rehearse_news_recovery_copy.py",
