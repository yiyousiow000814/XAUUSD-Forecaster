...
TOOL_INPUTS = ('scripts/architecture/architecture_compiler.py', 'scripts/architecture/compile_architecture.py',
               'scripts/architecture/extract_architecture_powershell.ps1',
               'scripts/architecture/extract_architecture_typescript.mjs',
               'scripts/architecture/architecture_typescript_tool.py')
...
def compile_index(root: Path):
    ...
    if typescript_files:
        ...
        result = subprocess.run([node, str(root / 'scripts/architecture/extract_architecture_typescript.mjs')],
