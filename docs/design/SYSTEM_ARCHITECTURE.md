...
| Collector | Python process with owned news and maintenance threads | News intake and evidence storage maintenance | Existing bounded news, backup, archival and WAL budgets | Source revisions and news collection heartbeat | Independent news and maintenance failure handling |
