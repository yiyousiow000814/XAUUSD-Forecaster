...
#104, #106, #108, #110, #111, #113, #114, #116, #117, #118, and #119 are merged
on `main`. The rows describe those bounded foundations and the structured
content implementation added by the current bounded scope.
