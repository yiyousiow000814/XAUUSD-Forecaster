...
class ForwardLedger:
    ...
    def __init__(self, path: str | Path, now: datetime | None = None) -> None:
        ...
        from xauusd_forecaster.evidence.projection_schema import install_dashboard_critical_activity_schema
        from xauusd_forecaster.evidence.projection_schema import install_dashboard_summary_schema
        from xauusd_forecaster.evidence.projection_schema import install_dashboard_read_model_schema
    ...
    def append_news_impact_assessment(self, record: dict[str, Any]) -> None:
        from xauusd_forecaster.news.annotation.impact import EVENT_STATES
        from xauusd_forecaster.news.annotation.impact import IDENTITY_RELATIONS
        from xauusd_forecaster.news.annotation.impact import IMPACT_CLASSES
        from xauusd_forecaster.news.annotation.impact import UPDATE_TYPES
    ...
    def append_decision(self, record: dict[str, Any], *, commit: bool = True) -> None:
        ...
        with self.connection if commit else nullcontext():
            ...
            from xauusd_forecaster.shadow_simulation import append_shadow_intents
    ...
    def append_outcome(self, record: dict[str, Any]) -> None:
        ...
        with self.connection:
            ...
            from xauusd_forecaster.shadow_simulation import append_shadow_results
