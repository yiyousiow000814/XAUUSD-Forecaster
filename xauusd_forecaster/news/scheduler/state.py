...
def install_scheduler_schema(connection: sqlite3.Connection) -> None:
    ...
    connection.commit()
    from xauusd_forecaster.news.semantics.critical_state import install_annotation_job_count_schema
...
def _live_pressure_tasks_for_quota(quota_authority: str) -> tuple[str, ...]:
    ...
    from xauusd_forecaster.ai.provider_registry import quota_surface_for_model
    from xauusd_forecaster.news.scheduler.task_registry import AI_TASK_ROUTES
...
def sync_pending_jobs(
    ...
    *,
    ...
    from xauusd_forecaster.news.annotation.product import TITLE_PROMPT_VERSION
    from xauusd_forecaster.news.annotation.product import pending_annotation_records
    from xauusd_forecaster.news.annotation.product import pending_impact_records
    from xauusd_forecaster.news.annotation.product import pending_title_translation_records
    ...
    from xauusd_forecaster.news.semantics.transitions import execute_transition_page
    ...
    from xauusd_forecaster.news.brief.product import brief_dates_to_process
...
def _reconciliation_input_key(
    ...
    from xauusd_forecaster.news.semantics.critical_state import news_job_input_revision
...
def _reconciliation_is_unchanged(
    ...
    from xauusd_forecaster.news.semantics.critical_state import NEWS_RECONCILIATION_CACHE_KEY
