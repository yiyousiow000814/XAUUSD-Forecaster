...
def execute_transition_page(
    ...
    *,
    ...
    from xauusd_forecaster.news.annotation.product import ANNOTATION_BODY_MIN_CHARACTERS, SUPPORTED_GEMINI_MODELS
    ...
    from xauusd_forecaster.news.scheduler.state import CONTRACT_BACKFILL_LANE, WorkProvenance
    from xauusd_forecaster.news.semantics.contracts import (
