...
from xauusd_forecaster.clock_commit import (
    completion_status,
    read_completed_clock,
)
...
class ForwardEngine:
    ...
    def append_clock_event(
        ...
        with self.ledger.clock_preparation():
            ...
            from xauusd_forecaster.decision.live import prepare_live_decision_v2
            from xauusd_forecaster.decision.live import persist_live_decision_v2
